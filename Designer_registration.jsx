...
export default class Designer_registration extends Component {
  constructor(props) {
    super(props);
    this.state = {
      countryData: [],
  ...
  saveData = (e) => {
    ...
    axios({
      method: "POST",
      url: "http://localhost/d-cart/backend/Guest/DesignerRegistration.php",
      data: formData,
    ...
    return (
      ...
      >
        <div className="head_pos">
          <h1 className="head_style">Designer Registration</h1>
        </div>
