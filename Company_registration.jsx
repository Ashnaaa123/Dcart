...
import Cb from "../../Assets/company.jpg";
import axios from "axios";

export default class Company_registration extends Component {
  constructor(props) {
    super(props);
    this.state = {
      countryData: [],
  ...
  saveData = (e) => {
    ...
    axios({
      method: "POST",
      url: "http://localhost/d-cart/backend/Guest/CompanyRegistration.php",
      data: formData,
    ...
    return (
      ...
      >
        <div className="head_pos">
          <h1 className="head_style">Company Registration</h1>
        </div>
          ...
          <table className="table">
            <tbody>
              ...
              <tr>
                <td>
                  {" "}
                  <h1 className="text_style">Proof</h1>
                </td>
                <td>
                  <input
                    name="proof"
